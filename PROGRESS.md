...
- **Next candidates:** demo projects for the share story - (a) a real imported LTspice `.asc` that simulates natively (class-d_starter.asc), (b) an AD8541 unity-buffer example exercising the Model libraries flow - staged into the DMG as an Examples folder. Then the docs honesty pass (README/SHARE/KNOWN_ISSUES + drop the LICENSE file), a hostile-review pass, and the fresh release DMG.
