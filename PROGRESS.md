...
- **Next candidates:** the two hostile-review fixes above, then the docs honesty pass (README vendor-model section is stale, drop the LICENSE file, KNOWN_ISSUES symbol-sheet convergence note), then the fresh release DMG with the Examples folder staged in.
