...
- ✅ **Class-D fidelity — the flagship circuit now SIMULATES correctly
  ...
  **Differential matrix slice (2026-08-05):** `scripts/differential-parity.sh`
  ...
  (truth). Gap-closure → **pass=46 · sibling=5 · gap=0**: prior cells through
  DCopPnt OP / audioamp / UHFpreamp / 1563 / LM308 / LM78XX / S-param plus
  Educational P2.asc authored `.tran` (exact 2N344/2N274/2N597; v(out)
  nRms≈0.0065). NE555 miss; 100W IRFP240/9240 not bundled (refuse, not silent).
  HalfSlope Laplace stripped; SoftDiodeRecovery deferred; BandGaps dc-temp miss;
  LoopGain/Electrometer LT1001 OTA wall; MC1648 deferred (probe stack).
