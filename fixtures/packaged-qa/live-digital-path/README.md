...
drives the named `LOGIC_OUT` net and `R_LOGIC_LOAD`. Use the **Toggle LOGIC_IN**
control to switch the input between 0 (LOW) and 1 V (HIGH); the real emitted
behavioral digital output follows the transition. Stop Live before editing.
