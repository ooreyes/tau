...
- [ ] **Broad differential parity, not a synthetic `.op` proxy:** the acceptance
      ...
      **Partial (2026-08-05):** `scripts/differential-parity.sh` +
      ...
      pass=46 · sibling=5 · gap=0 on stdout: prior cells through DCopPnt OP +
      Educational audioamp/UHFpreamp/1563/LM308/LM78XX/S-param + P2.asc authored
      `.tran` parametric amp (exact 2N344/2N274/2N597 + diodes; v(out) nRms≈0.0065).
      NE555 Output/Dischrg miss; 100W IRFP240/9240 not bundled (refuse). HalfSlope
      Laplace not landed. SoftDiodeRecovery deferred. BandGaps `.dc temp` misses
      tolerance. Harness-slice gap closed; broad topology/device matrix still open —
